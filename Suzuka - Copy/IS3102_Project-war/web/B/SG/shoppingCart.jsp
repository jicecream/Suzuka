                                    ...
                                    <div class="featured-box featured-box-secundary featured-box-cart">
                                        <div class="box-content">
                                            <form method="post" action="" name="shoppingCart">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="cart_table_item">
                                                            ...
                                                            <td class="product-name">
                                                                <a class="productDetails" href="furnitureProductDetails.jsp"><%= item.getName()%>
                                                            </td>
                                                            ...
                                                            <td class="product-quantity">
                                                                <form enctype="multipart/form-data" method="post" class="cart">
                                                                    <div class="quantity">
                                                                        ...
                                                                        {%>
                                                                        <input type="button" class="minus" value="-" disabled style="color:darkgrey;">
                                                                        <%}else{%>                                         
                                                                        <input type="button" class="minus" value="-" onclick="minus('<%=item.getSKU()%>')">
                                                                        <%}%>
                                                                        <input type="text" disabled class="input-text qty text" title="Qty" value="<%=item.getQuantity()%>" name="quantity" min="1" step="1" id="<%=item.getSKU()%>">
                                                ...
                                                <%} else {%>
                                                <div align="right"><a href="#checkoutModal" data-toggle="modal"><button disabled id="btnCheckout" class="btn btn-primary btn-lg">Check Out</button></a></div>
                                                <%}%>
                                            </form>
